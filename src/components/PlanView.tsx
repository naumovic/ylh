...
interface Props {
  ...
  onDownloadPdf: () => void;
  onDownloadJson: () => void;
  /** Hidden when ResultPanel already renders the headline above it. */
  showHeadline?: boolean;
}

export function PlanView({ plan, onDownloadPdf, onDownloadJson, showHeadline = true }: Props) {
  ...
  return (
    <div data-testid="plan-view">
      ...
      <div className="flex gap-3 mt-4" data-testid="plan-exports">
        ...
        {/* JSON export is a dev/internal convenience — hidden in production builds. */}
        {import.meta.env.DEV && (
          <button
